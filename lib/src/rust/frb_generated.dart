...
abstract class RustLibApi extends BaseApi {
  String responseText({required Response that, dynamic hint});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  String responseText({required Response that, dynamic hint}) {
    return handler.executeSync(SyncTask(
      callFfi: () {
        ...
        sse_encode_box_autoadd_response(that, serializer);
        return pdeCallFfi(generalizedFrbRustBinding, serializer, funcId: 4)!;
      },
      codec: SseCodec(
        decodeSuccessData: sse_decode_String,
        decodeErrorData: sse_decode_utf_8_decode_error,
      ),
      constMeta: kResponseTextConstMeta,
      argValues: [that],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kResponseTextConstMeta => const TaskConstMeta(
        debugName: "Response_text",
        argNames: ["that"],
      );
  ...
  Future<Response> get({required String url, dynamic hint}) {
    return handler.executeNormal(NormalTask(
      ...
      codec: SseCodec(
        ...
        decodeErrorData: sse_decode_network_error,
      ),
  ...
  TaskConstMeta get kGetConstMeta => const TaskConstMeta(
        debugName: "get",
        argNames: ["url"],
      );
  ...
  @protected
  NetworkError dco_decode_network_error(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
  ...
  @protected
  Utf8DecodeError dco_decode_utf_8_decode_error(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.isNotEmpty)
      throw Exception('unexpected arr length: expect 0 but see ${arr.length}');
    return const Utf8DecodeError();
  }
  ...
  @protected
  NetworkError sse_decode_network_error(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_reason = sse_decode_String(deserializer);
    return NetworkError(reason: var_reason);
  }
  ...
  Response sse_decode_response(SseDeserializer deserializer) {
    ...
    return Response(status: var_status, headers: var_headers, body: var_body);
  }
  ...
  @protected
  Utf8DecodeError sse_decode_utf_8_decode_error(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return const Utf8DecodeError();
  }
  ...
  @protected
  void sse_encode_network_error(NetworkError self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
  ...
  @protected
  void sse_encode_utf_8_decode_error(
      Utf8DecodeError self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
  }
